...
1. 개인정보 암호화
    - AWS KMS 암복호화 API 서비스 예정 

        - [우하한형제들 기술 블로그](http://woowabros.github.io/experience/2017/02/06/aws-kms.html), [데이터 전문가 지식포털](<http://www.dbguide.net/db.db?cmd=view&boardUid=152808&boardConfigUid=9&boardIdx=147&boardStep=1>)  포스팅 참고

        - 단, 양방향 암호화의 경우 가장 대중적으로 사용되는 라이브러리 사용 예정
